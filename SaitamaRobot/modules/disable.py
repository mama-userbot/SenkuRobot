...
if is_module_loaded(FILENAME):
    ...
    __help__ = """
Do you want to disable some selected cmnds for non admins in chat ? if yes you are in right place! with the help of this module, you can disable some cmnds for non admins.
